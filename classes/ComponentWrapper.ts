...
> extends ShadowAPI<{ props: ParentProps; state: MixedProps; }> {
    ...
    public getMixedProps(wrapped: Component<{ props?: ParentProps; state: MixedProps; }>): MixedProps {
        return this.onMixProps ? this.onMixProps(wrapped.props as ParentProps, this.builtProps as any, wrapped as any) : { ...wrapped.props, ...wrapped.state } as MixedProps;
    }
