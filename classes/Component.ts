...
export const createComponentWith = <Info extends Partial<ComponentInfo> = {}>(func: ComponentFuncWithCtxShortcut<Info>, name: string = func.name): ComponentFuncWith<Info> =>
    ...
    ({ [name]: function (_props: MixDOMPreComponentOnlyProps<Info["signals"] & {}> & Info["props"], component: ComponentWith<Info> & Info["class"], contextAPI: ContextAPIWith<Info>) { return (func as ComponentFuncWithCtxShortcut<Info>)(component, contextAPI); }})[name] as ComponentFuncWith<Info>;
